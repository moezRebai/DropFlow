    ...
    : ITimeSlotService
{
    ...
    public async Task<ResponseResult<int>> CreateAsync(CreateTimeSlotDto dto)
    {
        ...
        {
            return ResponseResult<int>.Failure("L'heure de fin doit �tre apr�s l'heure de d�but");
        }
    ...
    public async Task<ResponseResult> UpdateAsync(int id, UpdateTimeSlotDto dto)
    {
        ...
        if (dto.EndTime <= dto.StartTime)
        {
            return ResponseResult.Failure("L'heure de fin doit �tre apr�s l'heure de d�but");
        }
    ...
    public async Task<ResponseResult> DeleteAsync(int id)
    {
        ...
        if (usedInDeliveries)
        {
            return ResponseResult.Failure(
                ...
                "Vous pouvez le désactiver � la place.");
        }
