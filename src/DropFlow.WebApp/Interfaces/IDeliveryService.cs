...
public interface IDeliveryService
{
    ...
    // ═══ STATUS ═══
    Task<ResponseResult> UpdateStatusAsync(int id, Domain.Enums.DeliveryStatus status);
    Task<ResponseResult> BulkUpdateStatusAsync(List<int> ids, Domain.Enums.DeliveryStatus status);
