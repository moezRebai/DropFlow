    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantDepots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TenantDepots_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deliveries_ClientAddresses_ClientAddressId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_Drivers_UrgentDriverId",
                        column: x => x.UrgentDriverId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_TimeSlots_TimeSlotId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RouteTeam", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RouteTeam_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RouteTeam_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DeletedDate",
                table: "AspNetUsers",
                column: "DeletedDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_TenantId_Timestamp_Severity",
                table: "AuditLogs",
                columns: new[] { "TenantId", "Timestamp", "Severity" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_ClientAddressId",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_SequenceOrder",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_TenantId_ScheduledDate",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_TimeSlotId",
                table: "Deliveries",
                column: "TimeSlotId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_Type",
                table: "Deliveries",
                column: "Type");

            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_UrgentDriverId",
                table: "Deliveries",
                column: "UrgentDriverId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_ValidatedByDriverId",
                table: "Deliveries",
                column: "ValidatedByDriverId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteTeam_DriverId",
                table: "RouteTeam",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_RouteTeam_RouteId",
                table: "RouteTeam",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_RouteTeam_RouteId_DriverId",
                table: "RouteTeam",
                columns: new[] { "RouteId", "DriverId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RouteTeam_TenantId",
                table: "RouteTeam",
                column: "TenantId");
